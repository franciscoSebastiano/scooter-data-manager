...
heic_to_jpg_folder('imagesdirec') #call function to convert heic images to jpg

folder_data = get_folder_data('imagesdirec') #get data from each image in heic folder
print(folder_data[5])
